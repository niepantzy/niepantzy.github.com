...
this._mask_layer_le);a.stencilOp(a.KEEP,a.KEEP,a.KEEP)};a._onAfterVisit=function(a){a=a||cc._renderContext;cc.ClippingNode.WebGLRenderCmd._layer--;if(this._currentStencilEnabled){var c=1<<cc.ClippingNode.WebGLRenderCmd._layer,d=c|c-1;a.stencilMask(c);a.stencilFunc(a.EQUAL,d,d)}else a.disable(a.STENCIL_TEST)}})();var res={bg:"res/SavePets_Bg.png",one:"res/SavePets_Icon_Cube1.png",two:"res/SavePets_Icon_Cube2.png",three:"res/SavePets_Icon_Cube3.png",four:"res/SavePets_Icon_Cube4.png",five:"res/SavePets_Icon_Cube5.png",toonblastPlist:"res/toonblast.plist"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var Constant={CANDY_TYPE_COUNT:5,CANDY_WIDTH:64,MAP_SIZE:10,FALL_ACCELERATION:30,levels:[{limitStep:30,targetScore:500},{limitStep:25,targetScore:1E3},{limitStep:20,targetScore:2E3},{limitStep:20,targetScore:3E3},{limitStep:15,targetScore:4E3},{limitStep:10,targetScore:5E3}]};var Storage={getCurrentLevel:function(){var a=cc.sys.localStorage.getItem("level")||0;return parseInt(a)},setCurrentLevel:function(a){cc.sys.localStorage.setItem("level",a)},getCurrentScore:function(){var a=cc.sys.localStorage.getItem("score")||0;return parseInt(a)},setCurrentScore:function(a){cc.sys.localStorage.setItem("score",a)}};var Candy=cc.Sprite.extend({type:0,col:0,row:0,ctor:function(a,b,c){this._super("res/SavePets_Icon_Cube"+(a+1)+".png");this.setScale(Constant.CANDY_WIDTH/this.width,Constant.CANDY_WIDTH/this.height);this.init(a,b,c)},init:function(a,b,c){this.type=a;this.col=b;this.row=c}});Candy.createRandomType=function(a,b){return new Candy(parseInt(Math.random()*Constant.CANDY_TYPE_COUNT),a,b)};var GameUI=cc.Layer.extend({levelText:null,scoreText:null,stepText:null,gameLayer:null,targetText:null,ctor:function(a){this._super();this.gameLayer=a;this._initInfoPanel();this.scheduleUpdate()},_initInfoPanel:function(){var a=cc.director.getWinSize(),b=new cc.LabelTTF("Level","arial",36);b.x=100;b.y=a.height-50;b.setColor(cc.color(0,0,0));this.addChild(b);a=new cc.LabelTTF("1","arial",36);a.x=100;a.y=b.y-40;a.setColor(cc.color(0,0,0));this.addChild(a);this.levelText=a;var c=new cc.LabelTTF("Score",
"arial",36);c.x=270;c.y=b.y;c.setColor(cc.color(0,0,0));this.addChild(c);c=new cc.LabelTTF("1","arial",36);c.x=270;c.y=a.y;c.setColor(cc.color(0,0,0));this.addChild(c);this.scoreText=c;c=new cc.LabelTTF("Target","arial",36);c.x=450;c.y=b.y;c.setColor(cc.color(0,0,0));this.addChild(c);c=new cc.LabelTTF("1","arial",36);c.x=450;c.y=a.y;c.setColor(cc.color(0,0,0));this.addChild(c);this.targetText=c;c=new cc.LabelTTF("Step","arial",36);c.x=620;c.y=b.y;c.setColor(cc.color(0,0,0));this.addChild(c);b=new cc.LabelTTF("1",
"arial",36);b.x=620;b.y=a.y;b.setColor(cc.color(0,0,0));this.addChild(b);this.stepText=b},update:function(){this.levelText.setString(""+(this.gameLayer.level+1));this.scoreText.setString(""+this.gameLayer.score);this.stepText.setString(""+(this.gameLayer.limitStep-this.gameLayer.steps));this.targetText.setString(""+this.gameLayer.targetScore)},showSuccess:function(){var a=new cc.LayerColor(cc.color(255,255,255),500,500);this.addChild(a,1);var b=cc.director.getWinSize();a.x=(b.width-a.width)/2;a.y=
(b.height=a.height)/2;b=new cc.LabelTTF("\u606d\u559c\uff0c\u5df2\u5b8c\u6210\u7b2c"+(this.gameLayer.level+1)+"\u5173,\n\u5269\u4f59\u6b65\u657030\u500d\u5956\u52b1\uff01","arial",50);b.setColor(cc.color(0,0,0));b.x=250;b.y=250;a.addChild(b)},showSuccessAll:function(){var a=new cc.LayerColor(cc.color(255,255,255),500,500);this.addChild(a,1);var b=cc.director.getWinSize();a.x=(b.width-a.width)/2;a.y=(b.height=a.height)/2;b=new cc.LabelTTF("\u606d\u559c\u60a8\u5df2\u7ecf\u901a\u5173\uff01","arial",
50);b.setColor(cc.color(0,0,0));b.x=250;b.y=250;a.addChild(b)},showFail:function(){var a=new cc.LayerColor(cc.color(255,255,255),500,500);this.addChild(a,1);var b=cc.director.getWinSize();a.x=(b.width-a.width)/2;a.y=(b.height=a.height)/2;b=new cc.LabelTTF("\u5931\u8d25\u4e86\uff0c\n\u4ece\u5934\u6765\u8fc7\u5427\uff01","arial",50);b.setColor(cc.color(0,0,0));b.x=250;b.y=250;a.addChild(b)}});var GameScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;this.addChild(a)}}),GameLayer=cc.Layer.extend({mapPanel:null,ui:null,score:0,level:1,steps:0,limitStep:0,targetScore:0,moving:!1,over:!1,ctor:function(){this._super();var a=cc.director.getWinSize(),b=new cc.Sprite(res.bg);this.addChild(b);b.x=a.width/2;b.y=a.height/2;b.setScale(0.5,0.5);b.setScale(720/b.width,1280/b.height);cc.log("["+a.width+","+a.height+"]["+b.width+","+b.height+"]");b=new cc.ClippingNode;this.mapPanel=
new cc.Layer;this.mapPanel.x=(a.width-Constant.CANDY_WIDTH*Constant.MAP_SIZE)/2;this.mapPanel.y=(a.height-Constant.CANDY_WIDTH*Constant.MAP_SIZE)/2;b.addChild(this.mapPanel,1);a=new cc.DrawNode;a.drawRect(cc.p(this.mapPanel.x,this.mapPanel.y),cc.p(this.mapPanel.x+Constant.CANDY_WIDTH*Constant.MAP_SIZE,this.mapPanel.y+Constant.CANDY_WIDTH*Constant.MAP_SIZE),cc.color(255,255,255),10,cc.color(255,255,255));b.stencil=a;b.setColor(cc.color(255,255,255));this.addChild(b,2);this._init();"touches"in cc.sys.capabilities?
